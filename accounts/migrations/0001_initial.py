# Generated by Django 3.2.13 on 2022-11-17 06:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('array', multiselectfield.db.fields.MultiSelectField(choices=[(1, '풀배열'), (2, '텐키리스'), (3, '상관없음')], max_length=5, null=True)),
                ('sound', multiselectfield.db.fields.MultiSelectField(choices=[(1, '경쾌한 소리'), (2, '조용한 소리'), (3, '상관없음')], max_length=5, null=True)),
                ('rank', models.IntegerField(default=0)),
                ('connect', multiselectfield.db.fields.MultiSelectField(choices=[(1, '유선'), (2, '무선'), (3, '상관없음')], max_length=5, null=True)),
